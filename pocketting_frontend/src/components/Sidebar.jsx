...
const isNotActiveStyle = 'flex items-center px-5 gap-3 text-gray-500 hover:text-dash-black transition-all duration-200 ease-in-out capitalize';
...
const Sidebar = ( {user , closeToggle }) => {
  ...
  return (
    <div className="flex flex-col justify-between bg-white h-full overflow-y-sroll min-w-210 hide-scrollbar">
